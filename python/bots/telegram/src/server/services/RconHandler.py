...
import aiomcrcon
from python.bots.common.ConfigParser import RconConfigSchema
...
class RconHandler:
    ...
    async def execute(self, command: str) -> str | None:
        ...
        try:
            async with aiomcrcon.Client(self.__address, self.__config.password, self.__config.port) as client:
